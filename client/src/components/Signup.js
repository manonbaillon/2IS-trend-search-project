		          ...
		          <div className="card-body">
		            ...
		            <div className="form-signin">
		             <div className="form-label-group">
		                <input type="email" id="inputFirstName" className="form-control" placeholder="First name" name="firstName" value={ this.state.firstName } onChange={ this.onHandleChangefirstName } required />
		                <label htmlFor="inputEmail">First Name</label>
		              </div>
		              <div className="form-label-group">
		                <input type="email" id="inputLastName" className="form-control" placeholder="Last name" name="lastName" value={ this.state.lastName } onChange={ this.onHandleChangelastName } required />
		              ...
		              <button className="btn btn-lg btn-primary btn-block text-uppercase"  onClick={ this.onHandleClick } >Sign up</button>
		               <hr className="my-4" />
              		  <button className="btn btn-lg btn-google btn-block text-uppercase" >Log in to your account</button>
